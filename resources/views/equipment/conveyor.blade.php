...
@section('title','Conveyor Dashboard -')
@section('header','Conveyor Dashboard')
@section('additional-header')
<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#addequipment">Tambah Equipment Baru</button>
@endsection
@section('content')
<!-- /.KPI Card Group -->
