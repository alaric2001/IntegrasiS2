...
@section('title', $detail_ultra->nama .' Equipment Details -')
@section('header', $detail_ultra->nama .' Equipment Details')
@section('content')
    ...
    <table class="table border-0 my-3">
        <tbody>
            <tr>
                <td><b>ID</b></td>
                <td>:</td>
                <td>{{ $detail_ultra->id }}</td>
            </tr>
            <tr>
                <td class="fit"><b>Equipment Name</b></td>
                <td class="fit">:</td>
                <td>{{ $detail_ultra->nama }}</td>
            </tr>
            <tr>
                <td><b>Aktivitas</b></td>
                <td>:</td>
                <td>{{ $detail_ultra->activity->first()->nama }}</td>
            </tr>
            <tr>
                <td><b>Status</b></td>
                <td>:</td>
                <td>{{ $detail_ultra->status }}</td>
            </tr>
        </tbody>
    </table>
</div>
